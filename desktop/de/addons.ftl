...
addons-downloaded-fnames = %(fname)s heruntergeladen.
addons-downloading-adbd-kb02fkb = %(a)d/%(b)d (%(kb)0.2fKB) wird heruntergeladen...
addons-error-downloading-ids-errors = Fehler beim Herunterladen von <i>%(id)s</i>: %(error)s
addons-error-installing-bases-errors = Fehler beim Installieren von <i>%(base)s</i>: %(error)s
...
addons-installed-names = %(name)s installiert
...
addons-the-following-addons-are-incompatible-with = Die folgenden Erweiterungen sind inkompatibel mit %(name)s und wurden deaktiviert: %(found)s
