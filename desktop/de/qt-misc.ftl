...
qt-misc-configure-interface-language-and-options = Menüsprache und Optionen anpassen
...
qt-misc-ignore-this-update = Dieses Aktualisierung ignorieren
...
qt-misc-your-collection-file-appears-to-be = Die Datei Ihrer Sammlung scheint fehlerhaft zu sein. Zu diesem Zustand kann es kommen, wenn die Datei während einer laufenden Sitzung des Programms kopiert oder verschoben wird, oder wenn die Sammlung auf einem Netzlaufwerk oder einer Internet-Dateiablage gespeichert wird. Sollte das Problem nach einem Neustart des Computers weiterhin bestehen, bitten wir Sie, eine automatisch erstellte Sicherungskopie über die Profileinstellungen einzuspielen.
