...
qt-misc-the-requested-change-will-require-a = Сұралған өзгеріс келесі жолы коллекцияңызды синхрондағанда дерекқорды толық жүктеуді талап етеді. Егер басқа құрылғыда әлі осы жерге синхрондалмаған шолулар немесе басқа өзгерістер болса, олар жойылады. Жалғастырғыңыз келе ме?
