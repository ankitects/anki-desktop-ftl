...
qt-misc-replace-your-collection-with-an-earlier2 = Замінити поточну колекцію на колекцію з резервної копії від { $val }?
...
qt-misc-no-temp-folder = Придатна тимчасова тека відсутня. Переконайтеся, що C:\\temp існує або змінна оточення TEMP вказує на теку з можливістю запису.
qt-misc-incompatible-video-driver = У Вас несумісний відео-драйвер. Будь ласка, перезапустіть Anki щоб перемкнутися на повільніший, більш сумісний режим.
...
qt-misc-if-instance-is-not-responding = Якщо поточний примірник Anki не відповідає, закрийте його за допомогою диспетчера завдань або перезавантажте комп’ютер.
qt-misc-second =
    { $count ->
        [one] { $count } секунда
        [few] { $count } секунди
