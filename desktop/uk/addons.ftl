...
addons-window-title = Розширення
addons-addon-has-no-configuration = Розширення немає налаштувань.
addons-addon-installation-error = Помилка при встановлення додатка
addons-addon-was-not-downloaded-from-ankiweb = Розширення не завантажено з AnkiWeb.
addons-browse-addons = Переглянути додатки
...
addons-install-addons = Встановити розширення
...
addons-to-browse-addons-please-click-the = Для перегляду доповнень натисніть знизу кнопку перегляду.<br><br> Коли знайдете доповнення для встановлення, вставте його код знизу. Ви можете вставити декілька кодів, відокремленими пробілами.
