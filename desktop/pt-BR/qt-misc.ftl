...
qt-misc-please-connect-a-microphone-and-ensure = Por favor, conecte um microfone e certifique-se que outros programas não estejam usando o áudio.
...
qt-misc-unable-to-access-anki-media-folder = Não é possível acessar a pasta Anki. As permissões na pasta temporária do seu sistema podem estar incorretas.
