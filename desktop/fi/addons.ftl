...
addons-download-complete-please-restart-anki-to = Lataa kokonaan. Käynnistä Anki uudelleen, jotta muutokset tulevat voimaan.
...
addons-to-browse-addons-please-click-the = Voit selata lisäosia napsauttamalla alla olevaa Selaa-painiketta.<br><br>Kun olet löytänyt lisäosan, josta pidät, liitä sen koodi alle. Voit liittää useita koodeja välilyönneillä erotettuna.
