...
qt-misc-backing-up = Zálohuje sa...
...
qt-misc-your-collection-file-appears-to-be = Váš súbor kolekcie vyzerá byť poškodený. Toto sa stáva vtedy, keď je súbor kopírovaný alebo presunutý, kým je program Anki otvorený alebo keď je kolekcia uložená na sieti alebo v cloudovom disku. Ak problém pretrváva po reštarte počítača, prosím otvorte automatickú zálohu z okna s profilmi.
