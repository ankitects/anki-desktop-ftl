...
addons-install-addons = Inštalácia doplnku(ov)
...
addons-invalid-code-or-addon-not-available = Neplatný kód alebo doplnok nie je dostupný pre vašu verziu Anki.
...
addons-packaged-anki-addon = Zabalený Anki doplnok
addons-please-check-your-internet-connection = Skontrolujte, prosím, Vaše pripojenie k internetu.
addons-please-report-this-to-the-respective = Prosím, nahláste to autorovi(om) tohto doplnku.
...
addons-to-browse-addons-please-click-the = Ak chcete prechádzať doplnky, kliknite, prosím, na tlačidlo prehliadať nižšie.<br><br>Ak ste našli doplnok, ktorý sa Vám páči, prosím, zadajte jeho kód. Je možné zadať viacero kódov oddelených medzerami.
addons-toggle-enabled = Prepnúť povolenie
addons-unable-to-update-or-delete-addon = Doplnok sa nepodarilo aktualizovať alebo odstrániť. Spustite, prosím, Anki ešte raz a počas spustenia držte tlačidlo Shift, čím dočasne vypnete doplnky. Potom to skúste znovu.  Informácie pre ladenie: { $val }
