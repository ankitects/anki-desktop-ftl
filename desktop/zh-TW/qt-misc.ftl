...
qt-misc-in-order-to-ensure-your-collection = 為了確保你的集合能在不同裝置中運作，Anki 要求你電腦的內部時鐘設定正確。即使系統顯示的當地時間是對的，內部時鐘還是可能出現錯誤。<br><br>請在電腦上的時間設定中檢查：<br><br>- 上午/下午<br>- 時間飄移 (clock drift)<br>- 年月日<br>- 時區<br>- 夏令時間<br><br>與正確時間的差異：{ $val }。
