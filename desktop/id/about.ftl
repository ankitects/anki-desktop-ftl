...
about-if-you-have-contributed-and-are = Jika sudah berkontribusi tapi tidak tercantum, harap hubungi kami.
about-version = Versi { $val }
about-visit-website = <a href='{ $val }'>Kunjungi Situs</a>
about-written-by-damien-elmes-with-patches = Ditulis oleh Damien Elmes, dengan tambahan, terjemahan, pengujian, dan desain dari:<p>{ $cont }
# appended to the end of the contributor list in the about screen
about-and-others = dan lainnya
