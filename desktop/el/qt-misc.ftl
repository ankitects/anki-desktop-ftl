...
qt-misc-invalid-property-found-on-card-please = Μη έγκυρες ιδιότητες βρέθηκαν στην κάρτα. Παρακαλούμε χρησιμοποιήστε Εργαλέια > Έλεγχος βάσης δεδομένων και αν το πρόβλημα επανεμφανιστεί ρωτήστε στην ιστοσελίδα υποστήριξης.
...
qt-misc-unable-to-record =
    Αδυναμία εγγραφής. Παρακαλούμε βεβαιωθείτε ότι το μικρόφωνο είναι συνδεδεμένο και ότι το Anki έχει άδεια να το χρησιμοποιήσει.
    Αν άλλα προγράμματα χρησιμοποιούν το μικρόφωνο, το κλείσιμό τους μπορεί να βοηθήσει.
    
    Αρχικό σφάλμα: { $error }
qt-misc-please-ensure-a-profile-is-open = Παρακαλούμε βεβαιωθείτε ότι το προφίλ είναι ανοιχτό και ότι το Anki δεν είναι απασχολημένο και μετά ξαναδοκιμάστε.
qt-misc-please-select-1-card = (παρακαλούμε επιλέξτε 1 κάρτα)
...
qt-misc-your-collection-file-appears-to-be = Το αρχείο της συλλογής σας φαίνεται να είναι κατεστραμμένο. Αυτό μπορεί να συμβεί όταν ένα αρχείο αντιγράφεται ή μετακινείται όταν το Anki είναι ανοιχτό ή όταν η συλλογή αποθηκεύεται σε ένα δίκτυο ή δίσκο cloud. Αν τα προβλήματα επιμένουν μετά την επανεκκίνηση του υπολογιστή σας, παρακαλούμε ανοίξτε ένα αυτόματο αντίγραφο ασφαλείας στην οθόνη προφίλ.
qt-misc-your-computers-storage-may-be-full = Ο αποθηκευτικός χώρος του υπολογιστή σας ίσως είναι γεμάτος. Παρακαλούμε διαγράψτε αρχεία που δεν χρειάζεστε και μετά ξαναπροσπαθήστε.
