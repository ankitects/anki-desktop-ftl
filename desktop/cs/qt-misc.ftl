...
qt-misc-choose-deck = Vybrat Balík
...
qt-misc-create-filtered-deck = Vytvořit filtrovaný balík...
qt-misc-debug-console = Ladicí konzole
qt-misc-deck-will-be-imported-when-a = Balík bude importován při otevření profilu.
qt-misc-default = Výchozí
qt-misc-empty-cards = Prázdné karty...
qt-misc-error-during-startup = Chyba při spuštění: { $val }
qt-misc-filtered-deck = Filtrovaný balík { $val }
...
qt-misc-study-deck = Studovat balík...
qt-misc-sync = Synchronizace
qt-misc-target-deck-ctrlandd = Cílový balík (Ctrl+D)
qt-misc-the-following-character-can-not-be = Následující znak nemůže být použit: { $val }
qt-misc-the-requested-change-will-require-a = Požadovaná změna způsobí kompletní nahrání databáze na server při příští synchronizaci Vaší sbírky. Máte-li změny nebo naplánované zkoušení na jiném zařízení, které ještě nebyly synchronizovány, budou ztraceny. Chcete pokračovat?
...
qt-misc-unable-to-move-existing-file-to = Nelze přesunout stávající soubor do koše - prosím zkuste restartovat počítač.
qt-misc-undo = Zpět
