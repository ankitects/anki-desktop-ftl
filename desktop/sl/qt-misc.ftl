...
qt-misc-debug-console = Konzola za iskanje napak
qt-misc-deck-will-be-imported-when-a = Paket se bo uvozil, ko bo profil odprt.
qt-misc-empty-cards = Prazne kartice...
qt-misc-error-during-startup = Napaka med zagonom: { $val }
qt-misc-ignore-this-update = Spreglej to posodobitev
qt-misc-in-order-to-ensure-your-collection = Za pravilno sinhroniziranje kollekcije med več napravami Anki zahteva, da je notranja ura računalnika nastavljena pravilno. Notranja ura je lahko nastavljena napačno kljub temu, da vaš sistem kaže pravilen lokalni čas.<br><br>Prosimo, preverite v nastavitvah datuma in časa naslednje:<br>- AM/PM<br>- Zamik ure<br>- Dan, mesec in leto<br>- Časovni pas<br>- Poletni/zimski čas<br><br>Razlika do pravilnega časa: { $val }.
qt-misc-invalid-property-found-on-card-please = Na kartici smo našli napačno lastnost. Prosimo, uporabite Orodja>Preveri podatkovno bazo, če se težava ponovi, vas prosimo, da zastavite vprašanje na strani za podporo.
qt-misc-loading = Nalaganje ...
qt-misc-manage = Upravljanje
qt-misc-manage-note-types = Upravljaj tipe zapiskov
