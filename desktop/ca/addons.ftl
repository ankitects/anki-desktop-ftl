...
addons-important-as-addons-are-programs-downloaded = <b>Important:</b> Els complements que descarregueu d’internet poden contenir programari maliciós.<b>Instal·leu només aquells complements en què confieu.</b><br><br>Segur que voleu continuar amb la instal·lació del(s) següent(s) complement(s) d’Anki?<br><br>%(names)s
