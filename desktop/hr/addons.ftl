...
addons-install-addons = Instalirajte dodatk(e)
addons-install-anki-addon = Instalirajte Anki dodatak
addons-install-from-file = Instaliraj sa datoteke...
...
addons-invalid-code = Neispravan kod.
addons-invalid-code-or-addon-not-available = Nevažeći kod ili dodatak nije dostupan za vašu verziju Ankija.
addons-invalid-configuration = Nevažeća konfiguracija:
addons-invalid-configuration-top-level-object-must = Nevažeća konfiguracija: objekt najviše razine mora biti karta
...
addons-please-restart-anki-to-complete-the = <b>Molimo ponovno pokrenite Anki kako biste dovršili instalaciju.</b>
...
addons-view-addon-page = Prikaži stranicu s dodacima
...
addons-choose-update-window-title = Ažurirajte dodatke
