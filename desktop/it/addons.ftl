...
addons-browse-addons = Esplora add-on
...
addons-to-browse-addons-please-click-the = Per esplorare gli add-on, fare clic sul pulsante "Esplora add-on" qui sotto.<br><br>Una volta trovato un add-on di proprio interesse, incollare il suo codice qui sotto. È possibile inserire anche più codici separati da uno spazio.
