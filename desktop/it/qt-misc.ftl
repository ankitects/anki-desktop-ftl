...
qt-misc-change-note-type-ctrlandn = Cambia il tipo di nota (Ctrl+N)
qt-misc-check-the-files-in-the-media = Verifica i file nella cartella multimediale
qt-misc-choose-deck = Scegli il mazzo
qt-misc-choose-note-type = Scegli il tipo di nota
...
qt-misc-manage-note-types = Gestisci i tipi di nota
...
qt-misc-study-deck = Studia il mazzo...
